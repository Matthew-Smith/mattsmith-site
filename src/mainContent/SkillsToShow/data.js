...
export const data = [
  {
    ...
    where: [USAGES.personal, USAGES.coreAVI, USAGES.espial, USAGES.carleton]
  },
  {
    skill: "SVN",
    years: 4,
    category: CATEGORIES.versonControl,
    where: [USAGES.espial, USAGES.algonquin]
  },
  {
    skill: "JavaScript",
    years: 4,
    category: CATEGORIES.webTech,
    where: [USAGES.personal, USAGES.espial, USAGES.carleton]
  },
  {
    skill: "OpenGL / WebGL",
    years: 5,
    category: [CATEGORIES.webTech, CATEGORIES.gameDev, CATEGORIES.desktopApps],
    where: [USAGES.personal, USAGES.coreAVI, USAGES.espial, USAGES.algonquin]
  },
  {
    skill: "Python",
    years: 4,
    category: CATEGORIES.scripting,
    where: [USAGES.coreAVI, USAGES.espial, USAGES.carleton]
  },
  {
    skill: "HTML",
    years: 5,
    category: CATEGORIES.webTech,
    where: [USAGES.personal, USAGES.espial, USAGES.dnd, USAGES.carleton]
  },
  {
    skill: "CSS",
    years: 5,
  ...
  },
  {
    ...
    years: 2,
    category: CATEGORIES.webTech,
    where: [USAGES.personal, USAGES.espial]
  },
  {
  ...
  },
  {
    ...
    where: [USAGES.personal, USAGES.algonquin]
  },
  {
    skill: "Unity",
    years: 1,
    category: CATEGORIES.gameDev,
    where: [USAGES.personal]
  },
  {
    skill: "Java",
    years: 4,
    category: CATEGORIES.desktopApps,
    where: [USAGES.carleton, USAGES.algonquin]
  }
];
