...
const screenshot = 'https://raw.githubusercontent.com/Matthew-Smith/MenuSystem/master/screenshot.png';
...
const MenuSystem = ({ showPopup }) => {
    return (<ProjectCard
        ...
        <br />
        <br />
        This is a demonstration of using 2d canvases as textures for displaying text in WebGL as well as
        being a basic WebGL menu controllable with the keyboard.
        <h3>Controls:</h3>
